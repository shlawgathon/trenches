...
const sources: DataSourceSpec[] = [
  ...
  rssSource({
    id: "hezbollah-reuters",
    agentId: "hezbollah",
    delivery: "training_core",
    name: "Reuters Middle East",
    url: googleNewsSearchUrl('site:reuters.com (Hezbollah OR "south Lebanon" OR "Blue Line")'),
    allowlistStatus: "allowed",
    tags: ["hezbollah", "wire", "regional"],
    rationale: "Wire-grade regional reporting on Hezbollah, cross-border incidents, and escalation signals.",
    notes: FALLBACK_QUERY_NOTE,
  }),
  rssSource({
    id: "hezbollah-aljazeera",
    agentId: "hezbollah",
    delivery: "training_core",
    name: "Al Jazeera Middle East",
    url: googleNewsSearchUrl('site:aljazeera.com (Hezbollah OR "south Lebanon" OR Lebanon Israel border)'),
    allowlistStatus: "allowed",
    tags: ["hezbollah", "regional", "arabic-press"],
    rationale: "Regional coverage and political framing for Lebanon-border developments and Hezbollah signaling.",
    notes: FALLBACK_QUERY_NOTE,
  }),
  rssSource({
    id: "hezbollah-lorient-lejour",
    agentId: "hezbollah",
    delivery: "training_core",
    name: "L'Orient-Le Jour",
    url: googleNewsSearchUrl('site:lorientlejour.com (Hezbollah OR "south Lebanon" OR Lebanon Israel border)'),
    allowlistStatus: "allowed",
    tags: ["hezbollah", "lebanon", "local-press"],
    rationale: "Lebanese local reporting on domestic pressure, border incidents, and Hezbollah-linked political fallout.",
    notes: FALLBACK_QUERY_NOTE,
  }),
  rssSource({
    id: "hezbollah-naharnet",
    agentId: "hezbollah",
    delivery: "training_core",
    name: "Naharnet",
    url: googleNewsSearchUrl('site:naharnet.com (Hezbollah OR "south Lebanon" OR Lebanon Israel border)'),
    allowlistStatus: "allowed",
    tags: ["hezbollah", "lebanon", "breaking"],
    rationale: "Lebanon-focused breaking coverage for Hezbollah-linked security and political developments.",
    notes: FALLBACK_QUERY_NOTE,
  }),
