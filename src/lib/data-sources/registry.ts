...
const sources: DataSourceSpec[] = [
  ...
  rssSource({
    id: "israel-bbc-middle-east",
    agentId: "israel",
    delivery: "training_core",
    name: "BBC Middle East",
    url: "https://feeds.bbci.co.uk/news/world/middle_east/rss.xml",
    allowlistStatus: "allowed",
    tags: ["israel", "regional", "wire"],
    rationale: "External regional framing of Israeli operations and responses.",
  }),
  rssSource({
  ...
  videoSource({
    id: "israel-aljazeera-english-live",
    agentId: "israel",
    delivery: "live_demo",
    name: "Al Jazeera English Live",
    channel: "@AlJazeeraEnglish",
    tags: ["israel", "live", "regional-media"],
    rationale: "Regional broadcast framing of Israeli military moves during live sessions.",
  }),
  videoSource({
    id: "israel-al-hadath-live",
    agentId: "israel",
    delivery: "live_demo",
    name: "Al Hadath Live",
    channel: "@AlHadath",
    tags: ["israel", "live", "regional-media"],
    rationale: "Arabic breaking coverage useful for monitoring regional reaction to Israeli actions.",
  }),
  videoSource({
    id: "israel-asharq-news-live",
    agentId: "israel",
    delivery: "live_demo",
    name: "Asharq News Live",
    channel: "@asharqnews",
    tags: ["israel", "live", "regional-media"],
    rationale: "Gulf-facing regional lens on Israeli escalation and diplomacy.",
  }),
  ...
  rssSource({
    id: "hezbollah-guardian-middle-east",
    agentId: "hezbollah",
    delivery: "training_core",
    name: "Guardian Middle East",
    url: "https://www.theguardian.com/world/middleeast/rss",
    allowlistStatus: "allowed",
    tags: ["hezbollah", "regional", "analysis"],
    rationale: "External regional reporting with Lebanese and Syrian theater coverage.",
  }),
  rssSource({
    id: "hezbollah-al-jazeera-arabic",
    agentId: "hezbollah",
    delivery: "training_core",
    name: "Al Jazeera Arabic",
    url: "https://www.aljazeera.net/aljazeerarss/a7c186be-1adb-4b11-a982-4783e765316e/4e17ecdc-8fb9-40de-a5d6-d00f72384a51",
    allowlistStatus: "external",
    tags: ["hezbollah", "arabic", "regional"],
    rationale: "Arabic-language regional news lane aligned with the Hezbollah information environment.",
  }),
  worldMonitorSource({
  ...
  videoSource({
    id: "hezbollah-rudaw-live",
    agentId: "hezbollah",
    delivery: "live_demo",
    name: "Rudaw Live",
    channel: "@rudaw",
    tags: ["hezbollah", "live", "regional-media"],
    rationale: "Regional Kurdish/Levant live coverage for cross-border developments.",
  }),
